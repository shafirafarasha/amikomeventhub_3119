            ...
            <form action="{{ route('checkout.store', $event->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="customer_name"
                           ...
                           class="w-full px-5 py-4 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none font-medium"
                           required
                ...
                <button type="submit"
                        class="w-full py-5 bg-indigo-600 text-white rounded-2xl font-black text-xl shadow-xl hover:bg-indigo-700 active:scale-95 transition">
                    Lanjut Pembayaran
                </button>
